...
# Verify faesm and flash-attn are available
echo "Checking UV environment packages..."
uv pip list | grep -E "(faesm|flash-attn)" || echo "No faesm/flash-attn packages found"
